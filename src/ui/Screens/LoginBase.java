    ...
    public LoginBase() {
        ...
        login_btn.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                LoginRequest loginRequest = new LoginRequest(email_tf.getText(), password_tf.getText());
                loginRequest.setRequestType(NetworkRequest.RequestType.LOGIN);
                loginRequest.setIp(SocketConnection.getInstance().getLocalIp());
                String loginJson = new Gson().toJson(loginRequest.toArray());
                System.out.println(loginJson);
                SocketConnection.getInstance().getSender().println(loginJson);
                ...
                System.out.println("response in login" + s);
        ...
        imageView.setPickOnBounds(
                true);
        imageView.setImage(
                new Image(getClass().getResource("/assets/background.png").toExternalForm()));
        ...
        label.setFont(
                new Font("Berlin Sans FB Bold", 75.0));
        ...
        flowPane.setPrefHeight(
                329.0);
        flowPane.setPrefWidth(
                625.0);
        ...
        flowPane0.setPrefHeight(
                200.0);
        flowPane0.setPrefWidth(
                200.0);
        flowPane0.setRowValignment(javafx.geometry.VPos.BOTTOM);

        back_btn.setMinHeight(
                20.0);
        back_btn.setMinWidth(
                20.0);
        back_btn.setMnemonicParsing(
                false);
        back_btn.setPrefHeight(
                21.0);
        back_btn.setPrefWidth(
                58.0);
        FlowPane.setMargin(back_btn,
                new Insets(0.0, 0.0, -2.0, 90.0));
        ...
        login_btn.setMinHeight(
                50.0);
        login_btn.setMinWidth(
                150.0);
        login_btn.setMnemonicParsing(
                false);
        login_btn.setPrefHeight(
                31.0);
        login_btn.setPrefWidth(
                93.0);
        BorderPane.setMargin(login_btn,
                new Insets(-50.0, 0.0, 55.0, 0.0));
        ...
        label0.setFont(
                new Font("Berlin Sans FB Bold", 34.0));
        StackPane.setMargin(label0,
                new Insets(-15.0, 0.0, 0.0, 0.0));

        StackPane.setAlignment(email_tf, javafx.geometry.Pos.CENTER);

        email_tf.setMaxWidth(
                453.0);
        email_tf.setMinHeight(
                40.0);
        email_tf.setMinWidth(
                0.0);
        email_tf.setPrefHeight(
                49.0);
        email_tf.setPrefWidth(
                0.0);
        StackPane.setMargin(email_tf,
                new Insets(-85.0, 10.0, 0.0, 0.0));
        email_tf.setCursor(Cursor.TEXT);

        email_tf.setFont(
                new Font("Berlin Sans FB Demi Bold", 20.0));

        password_tf.setMaxWidth(
                453.0);
        password_tf.setMinHeight(
                40.0);
        password_tf.setMinWidth(
                0.0);
        password_tf.setPrefHeight(
                49.0);
        password_tf.setPrefWidth(
                0.0);
        StackPane.setMargin(password_tf,
                new Insets(130.0, 0.0, 0.0, 0.0));

        label1.setAlignment(javafx.geometry.Pos.BOTTOM_LEFT);

        label1.setPrefHeight(
                20.0);
        label1.setPrefWidth(
                464.0);
        label1.setText(
        ...
        label1.setFont(
                new Font("Berlin Sans FB Bold", 34.0));
        StackPane.setMargin(label1,
                new Insets(40.0, -5.0, 0.0, 0.0));

        getChildren()
                .add(imageView);
        flowPane0.getChildren()
                .add(back_btn);
        getChildren()
                .add(borderPane);
        getChildren()
